...
import type { ChatBackground } from './chat-background.ts';
import type { ChatBoostAdded } from './chat-boost-added.ts';
import type { ChatShared } from './chat-shared.ts';
import type { Checklist } from './check-list.ts';
import type { ChecklistTasksAdded } from './check-list-tasks-added.ts';
import type { ChecklistTasksDone } from './check-list-tasks-done.ts';
import type { Contact } from './contact.ts';
import type { Dice } from './dice.ts';
import type { DirectMessagePriceChanged } from './direct-message-price-changed.ts';
import type { DirectMessagesTopic } from './direct-message-topic.ts';
import type { Document } from './document.ts';
import type { ExternalReplyInfo } from './external-reply-info.ts';
import type { ForumTopicClosed } from './forum-topic-closed.ts';
import type { ForumTopicCreated } from './forum-topic-created.ts';
import type { ForumTopicEdited } from './forum-topic-edited.ts';
import type { ForumTopicReopened } from './forum-topic-reopened.ts';
import type { Game } from './game.ts';
import type { GeneralForumTopicHidden } from './general-forum-topic-hidden.ts';
import type { GeneralForumTopicUnhidden } from './general-forum-topic-unhidden.ts';
import type { GiftInfo } from './gift-info.ts';
import type { Giveaway } from './give-away.ts';
import type { GiveawayCompleted } from './give-away-completed.ts';
import type { GiveawayCreated } from './give-away-created.ts';
...
import type { MessageAutoDeleteTimerChanged } from './message-auto-delete-timer-changed.ts';
import type { MessageEntity } from './message-entity.ts';
import type { MessageOrigin } from './message-origin.ts';
import type { PaidMediaInfo } from './paid-media-info.ts';
import type { PaidMessagePriceChanged } from './paid-message-price-changed.ts';
import type { PassportData } from './passport-data.ts';
import type { PhotoSize } from './photo-size.ts';
import type { Poll } from './poll.ts';
import type { ProximityAlertTriggered } from './proximity-alert-triggered.ts';
import type { RefundedPayment } from './refunded-payment.ts';
import type { Sticker } from './sticker.ts';
import type { Story } from './story.ts';
import type { SuccessfulPayment } from './successful-payment.ts';
import type { SuggestedPostApprovalFailed } from './suggested-post-approval-failed.ts';
import type { SuggestedPostDeclined } from './suggested-post-declined.ts';
import type { SuggestedPostInfo } from './suggested-post-info.ts';
import type { SuggestedPostPaid } from './suggested-post-paid.ts';
import type { SuggestedPostRefunded } from './suggested-post-refunded.ts';
import type { TextQuote } from './text-quote.ts';
import type { UniqueGiftInfo } from './unique-gift-info.ts';
import type { User } from './user.ts';
import type { UsersShared } from './users-shared.ts';
import type { Venue } from './venue.ts';
import type { Video } from './video.ts';
import type { VideoChatEnded } from './video-chat-ended.ts';
import type { VideoChatParticipantsInvited } from './video-chat-participants-invited.ts';
import type { VideoChatScheduled } from './video-chat-scheduled.ts';
import type { VideoChatStarted } from './video-chat-started.ts';
import type { VideoNote } from './video-note.ts';
import type { Voice } from './voice.ts';
import type { WebAppData } from './web-app-data.ts';
import type { WriteAccessAllowed } from './write-access-allowed.ts';
